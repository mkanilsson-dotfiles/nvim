...
set("n", "<space>kp", function()
    utils.expand_and_copy("%")
end, { desc = "Path" })
set("n", "<space>kf", function()
    utils.expand_and_copy("%:t")
end, { desc = "Filename" })
set("n", "<space>kd", function()
    utils.expand_and_copy("%:h")
end, { desc = "Directory" })
set("n", "<space>kb", function()
    utils.copy(vim.fn.system('git branch --show-current'):gsub('\n', ''))
end, { desc = "Git Branch" })
